        ...
        <div className="flex flex-col-reverse lg:flex-row items-center justify-between lg:pt-8 lg:pb-20">
          ...
          <div className="text-center lg:text-left">
            ...
            <p className="max-w-[500px] leading-snug mb-9 text-white/80">
              ...
              with 2+ years of experience specializing in{" "}
              <span className="font-bold text-white">
                Node.js, NestJS, and TypeScript
              </span>
              . Experienced in building scalable REST APIs, microservices,
              real-time systems, and subscription-based platforms using{" "}
              <span className="font-bold text-white">
                PostgreSQL, MongoDB, Redis, AWS, and Docker
              </span>
              . Passionate about clean architecture, performance, and reliable
              backend systems.
            </p>
