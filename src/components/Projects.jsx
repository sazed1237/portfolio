...
export const projects = {
  ...
  items: [
    ...
    },
    {
      ...
      description:
        "Created a dynamic movie and TV show website using the MERN stack, Tailwind CSS, and The Movie Database (TMDB) API. The platform allows users to watch movies and TV series, providing detailed information on each title. This project highlights proficiency in integrating live APIs and developing interactive, user-friendly interfaces.",
      stack: [
        { name: "Html 5" },
        { name: "tailwind css" },
        { name: "javascript" },
